...
async function OIDCCallback(pluginType, request, providerConfig) {
  ...
  const authenticationURL = new URL(`${request.origin}/api/${pluginType}/oauth/authentication/${providerConfig.id}`);
