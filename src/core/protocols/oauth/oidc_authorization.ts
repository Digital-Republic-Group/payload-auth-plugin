...
export async function OIDCAuthorization(
  ...
  console.error("OIDCAuthorization called with redirectUri:", redirectUri)
  ...
  if (redirectUri) {
    authorizationURL.searchParams.set("state", encodeURIComponent(redirectUri))
  }
  console.error("authorizationURL", authorizationURL.href)
